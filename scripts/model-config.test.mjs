...
test('browser connection tests use a separate sixty-second deadline and response grace period',async()=>{
  ...
  assert.deepEqual(durations,[65000,65000,65000,65000,65000]);
});
