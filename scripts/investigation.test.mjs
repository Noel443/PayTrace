...
function setup(){
  ...
  for(const file of ['limits','workspaces','investigation','mock-api'])vm.runInContext(readFileSync(new URL(`../${['workspaces','mock-api'].includes(file)?'scripts/fixtures':'frontend'}/${file}.js`,import.meta.url),'utf8'),c);
