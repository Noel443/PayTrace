...
async function runFollowup(r,attachments){
  ...
  if($('#followup-question').value.length>PayTraceLimits.question){$('#followup-status').textContent='追问最多 20 万字符，请缩短后重试';return}
